...
def setupMainWindow():
    ...
    layout = [
        [sg.Button("Launch City Evironment"), sg.Button("Launch Demo Evironment")],
...
def main():
    ...
    while True:
        ...
        elif event == "Launch City Evironment":
            projectPath = os.path.dirname(__file__)
            partialPath = "CityEnvironment\\CityEnviron.exe"
            fullCityEnviroPath = os.path.join(projectPath, partialPath)
            os.startfile(fullCityEnviroPath)
